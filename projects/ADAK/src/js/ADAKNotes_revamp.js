...
let AKAD = [
   ...
   //    codepenEmbed: `<iframe height="800" style="width: 100%;" scrolling="no" title="IntersctionObserver() Basics" src="https://codepen.io/kevinmnm/embed/eYzZEXN?height=265&theme-id=dark&default-tab=result" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
